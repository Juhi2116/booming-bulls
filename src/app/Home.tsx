  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto relative py-20">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 top-20 bottom-20 w-1">
          {/* Background line */}
              ...
              <div className="w-full flex items-center">
                {isRight ? (
                  <>
                    ...
                    <div
                      className={`flex-1 pl-20 text-left transition-all duration-500 ${
                        isActive
                  ...
                  <>
                    <div
                      className={`flex-1 pr-20 text-right transition-all duration-500 ${
                        isActive
                          ? 'opacity-100 transform translate-x-0'
                          : 'opacity-50 transform -translate-x-8'
                      }`}
